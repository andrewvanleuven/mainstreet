...
dfn <- read_csv("data/csv/employment/epanel_nn_buff2.csv") %>% 
  mutate(outcome_var = (jobs/(pop_2010/100)))

dfs <- read_csv("data/csv/employment/epanel_stack_buff2.csv") %>% 
  filter(distance > 5 | distance == 0) %>% 
  mutate(outcome_var = (jobs/(pop_2010/100)))

#retail establishments per capita
dfen <- read_csv("data/csv/employment/epanel_nn_buff2.csv") %>% 
  mutate(outcome_var = (ests/(pop_2010/100)))

dfes <- read_csv("data/csv/employment/epanel_stack_buff2.csv") %>% 
  filter(distance > 5 | distance == 0) %>% 
  mutate(outcome_var = (ests/(pop_2010/100)))
...
#retail ests pk lead
ldfen <- read_csv("data/csv/employment/epanel_nn_buff2.csv") %>% 
  mutate(outcome_var = (ests_lead/(pop_2010/100)))

ldfes <- read_csv("data/csv/employment/epanel_stack_buff2.csv") %>% 
  filter(distance > 5 | distance == 0) %>% 
  mutate(outcome_var = (ests_lead/(pop_2010/100)))
...
stargazer::stargazer(rnpa,rnya,rspa,rsya,
                     digits = 2,
                     type="text",
                     out = "results/employment/buffers1_2/jobs.html",
...
stargazer::stargazer(rnpa,rnya,rspa,rsya,
                     digits = 2,
                     type="text",
                     out = "results/employment/buffers1_2/ests.html",
                     covariate.labels = c("Treated * Post", "Treated * Rel. Year -3", "Treated * Rel. Year -1",
                                          "Treated * Rel. Year 0", "Treated * Rel. Year 1", "Treated * Rel. Year 2",
                                          "Treated * Rel. Year 3", "Treated * Rel. Year 4", "Treated * Rel. Year 5"),
...
stargazer::stargazer(rnpa,rnya,rspa,rsya,
                     digits = 2,
                     type="text",
                     out = "results/employment/buffers1_2/jobs_lead.html",
                     covariate.labels = c("Treated * Post", "Treated * Rel. Year -3", "Treated * Rel. Year -1",
                                          "Treated * Rel. Year 0", "Treated * Rel. Year 1", "Treated * Rel. Year 2",
                                          "Treated * Rel. Year 3", "Treated * Rel. Year 4", "Treated * Rel. Year 5"),
...
stargazer::stargazer(rnpa,rnya,rspa,rsya,
                     digits = 2,
                     type="text",
                     out = "results/employment/buffers1_2/ests_lead.html",
                     covariate.labels = c("Treated * Post", "Treated * Rel. Year -3", "Treated * Rel. Year -1",
                                          "Treated * Rel. Year 0", "Treated * Rel. Year 1", "Treated * Rel. Year 2",
                                          "Treated * Rel. Year 3", "Treated * Rel. Year 4", "Treated * Rel. Year 5"),
...
stargazer::stargazer(rnpa,rnya,rspa,rsya,
                     ...
                     digits = 2,
                     type="text",
                     out = "results/employment/buffers1_2/jobs_states.html",
                     covariate.labels = c("Treated * Post", "Treated * Rel. Year -3", "Treated * Rel. Year -1",
                                          "Treated * Rel. Year 0", "Treated * Rel. Year 1", "Treated * Rel. Year 2",
                                          "Treated * Rel. Year 3", "Treated * Rel. Year 4", "Treated * Rel. Year 5"),
                     dep.var.caption = "Dependent Variable: Downtown Jobs Per-Capita",
...
stargazer::stargazer(rnpa,rnya,rspa,rsya,
                     ...
                     digits = 2,
                     type="text",
                     out = "results/employment/buffers1_2/ests_states.html",
                     covariate.labels = c("Treated * Post", "Treated * Rel. Year -3", "Treated * Rel. Year -1",
                                          "Treated * Rel. Year 0", "Treated * Rel. Year 1", "Treated * Rel. Year 2",
                                          "Treated * Rel. Year 3", "Treated * Rel. Year 4", "Treated * Rel. Year 5"),
                     dep.var.caption = "Dependent Variable: Downtown Establishments Per-Capita",
